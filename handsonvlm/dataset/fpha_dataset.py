...
from hoi_forecast.dataset_general.dataset_fpha import FPHAHandTrajectoryDataset
from hoi_forecast.utils.const import anticipation_frames_num
from handsonvlm.constants import DEFAULT_IMAGE_TOKEN, action_question_templates, action_answer_templates
from handsonvlm.dataset.base_dataset import preprocess
from handsonvlm.dataset.epic_dataset import preprocess_multimodal

class FPHAConversationDataset(Dataset):
    def __init__(self, tokenizer, dataset: FPHAHandTrajectoryDataset, deterministic=False):
        super(FPHAConversationDataset, self).__init__()
        self.dataset: FPHAHandTrajectoryDataset = dataset
