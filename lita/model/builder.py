...
from handsonvlm.model.language_model.utils import *
from lita.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, TIME_TOKEN_TEMPLATE


AutoConfig.register("liha-full", LihaConfig_full)
AutoModelForCausalLM.register(LihaConfig_full, LihaLlamaForCausalLM_full)
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto"):
    ...
    if model_base is not None:
        ...
        model = LihaLlamaForCausalLM_full.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
        ...
        model = LihaLlamaForCausalLM_full.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
